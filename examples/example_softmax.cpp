...
int main(int argc, char* argv[]){
    ...
    float train_accuracy = ClassMetrics::multiclass_accuracy(net, X_train, y_train, true);
    std::cout << "## Train Accuracy: " << train_accuracy * 100.0f << "%\n";

    float test_accuracy = ClassMetrics::multiclass_accuracy(net, X_test, y_test, true);
